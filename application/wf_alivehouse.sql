...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2017-06-05 23:33:39
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='权限允许禁止表';
...
CREATE TABLE IF NOT EXISTS `ah_building_base` (
  ...
  `namePinyin` varchar(255) DEFAULT NULL COMMENT '楼盘名称拼音',
  `pinyin` varchar(255) DEFAULT NULL COMMENT '楼盘拼音首字母',
  `address` varchar(255) NOT NULL COMMENT '地址',
  `created_at` datetime NOT NULL COMMENT '创建时间',
  `updated_at` datetime NOT NULL COMMENT '修改时间'
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='楼盘表';

--
-- 转存表中的数据 `ah_building_base`
--

INSERT INTO `ah_building_base` (`id`, `is_delete`, `type`, `city_id`, `name`, `namePinyin`, `pinyin`, `address`, `created_at`, `updated_at`) VALUES
(2, 1, 1, 2, '中海国际', NULL, NULL, '海口中海国际', '2017-06-01 21:51:52', '2017-06-01 21:51:52'),
(3, 1, 1, 4, '怡心花园', NULL, NULL, '儋州市怡心花园2期', '2017-06-01 21:54:42', '2017-06-01 21:54:42');
...
CREATE TABLE IF NOT EXISTS `ah_house` (
  `id` bigint(20) NOT NULL COMMENT 'ID',
  `is_delete` tinyint(1) NOT NULL DEFAULT '1' COMMENT '时效;0=失效,1=有效;默认1;',
  ...
  `building_base_id` bigint(20) DEFAULT NULL COMMENT '楼盘表ID',
  `back_user_id` bigint(20) DEFAULT NULL COMMENT '业务员表ID',
  `suite_name` varchar(255) DEFAULT NULL COMMENT '小区名称',
...
(2, '业务服务', NULL, NULL, 1, 3, '{"li_class":"","a_class":"User","i_class":"fa fa-circle-o"}'),
(3, '个人信息', NULL, NULL, 2, 3, '{"li_class":"","a_class":"Back","i_class":"fa fa-circle-o"}'),
(4, '信息录入', NULL, NULL, 3, 3, '{"li_class":"","a_class":"Back","i_class":"fa fa-circle-o"}'),
...
(74, '出租录入', 4, '/manage/rent/create', 4, 3, '{"li_class":"","a_class":"Back","i_class":"fa fa-circle-o"}'),
(75, '楼盘录入', 4, '/manage/build/create', 5, 3, '{"li_class":"","a_class":"Back","i_class":"fa fa-circle-o"}'),
(76, '交易录入', 4, '/manage/order/create', 6, 3, '{"li_class":"","a_class":"Back","i_class":"fa fa-circle-o"}'),
(77, '录入清单', 4, '/manage/import/index', 7, 3, ''),
...
(93, '出租录入', 5, '/manage/rent/create', 3, 0, '{"li_class":"","a_class":"Back","i_class":"fa fa-circle-o"}'),
...
(194, '出租广告', 10, '/manage/slider/rent', 4, 0, '{"li_class":"","a_class":"Back","i_class":"fa fa-circle-o"}'),
...
(233, '出租资讯', 12, '/manage/rent/hot', 3, 0, '{"li_class":"","a_class":"Back","i_class":"fa fa-circle-o"}'),
...
CREATE TABLE IF NOT EXISTS `ah_type_park` (
  `id` bigint(20) NOT NULL COMMENT 'ID',
  `is_delete` tinyint(1) NOT NULL DEFAULT '1' COMMENT '时效;0=失效,1=有效;默认1;',
  `type_id` bigint(20) NOT NULL COMMENT '类型表ID',
  `target_id` bigint(20) NOT NULL COMMENT '目标表ID;根据type值外联',
  `group` tinyint(1) NOT NULL DEFAULT '1' COMMENT '父级类型:0=失效,1=预定,2=客户,3=房东,4=新房,5=二手房,6=楼房,7=客服,8=;默认1;',
  `name` varchar(32) NOT NULL COMMENT '标签',
  `description` varchar(255) NOT NULL COMMENT '详细描述',
...
--
-- Indexes for table `ah_house`
--
ALTER TABLE `ah_house`
  ADD PRIMARY KEY (`id`),
  ADD KEY `building_base_id` (`building_base_id`),
  ADD KEY `back_user_id` (`back_user_id`);
...
--
-- Indexes for table `ah_images`
--
ALTER TABLE `ah_images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `back_user_id` (`back_user_id`);
...
ALTER TABLE `ah_hot`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID';
--
-- AUTO_INCREMENT for table `ah_house`
--
ALTER TABLE `ah_house`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID';
--
...
ALTER TABLE `ah_house_host_server`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID';
--
-- AUTO_INCREMENT for table `ah_images`
--
ALTER TABLE `ah_images`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID';
--
...
--
ALTER TABLE `ah_ban`
  ADD CONSTRAINT `ah_ban_ibfk_1` FOREIGN KEY (`item_name`) REFERENCES `ah_auth_item` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ah_ban_ibfk_2` FOREIGN KEY (`back_user_id`) REFERENCES `ah_back_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `ah_house`
  ADD CONSTRAINT `ah_house_ibfk_1` FOREIGN KEY (`back_user_id`) REFERENCES `ah_back_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `ah_house_ibfk_2` FOREIGN KEY (`building_base_id`) REFERENCES `ah_building_base` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `ah_images`
  ADD CONSTRAINT `ah_images_ibfk_1` FOREIGN KEY (`back_user_id`) REFERENCES `ah_back_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
