...
<head>
    ...
    <style id="styleWebSite" type="text/css">
        #header-content-container{width:1200px;}
        #main-content-container{width:1200px;}
        #footer-content-container{width:1200px;}
        #extra-content-container{width:1200px;}
...
<body id="alive-site-body">


<div id="alive-site-main" class="alive-site-main">

    <div id="alive-site-web" class="alive-site-web">
...
<section id="header-content-container" class="header-content-container flex">
    ...
    <!-- 顶级 全屏操作 容器 开始 -->
    <section id="header-full-container">
    ...
    <div class="header-body">
        ...
        <section id="headerTopTable" class="topTable">
            ...
            <!-- 左侧 区域开启 -->
            <section class="leftTable flex-top-left">

            </section>
            <!-- 左侧 区域结束 -->

            <!-- 中间 区域开启 -->
            <section class="centerTable flex-top-center">

            </section>
            <!-- 中间 区域结束 -->

            <!-- 右侧 区域开启 -->
            <section class="rightTable flex-top-left">
        ...
        <section id="headerMiddleTable" class="middleTable">
            ...
            <!-- 顶级主体 左侧 logo区域开启 -->
            <section id="headerLeft" class="leftTable flex-middle-left">
            ...
            <!-- 顶级主体 中间 区域导航开启 -->
            <section id="headerCenter" class="centerTable flex-middle-center" style="display: none;">
            ...
            <!-- 顶级主体 右侧 区域导航开启 -->
            <section id="headerRight" class="rightTable flex-middle-right">

                <div id="headerNav" class="headerNav">

                    <span class="item">
                        <a hidefocus="true" style="outline:none;" href="/home/index/index.html" target="_self" onclick=""><span class="itemName">Home</span></a>
                    </span>

                    <span class="item">
                        <a hidefocus="true" style="outline:none;" href="/home/better/better.html" target="_self" onclick=""><span class="itemName">Better</span></a>
                    </span>

                    <span class="item">
                        <a hidefocus="true" style="outline:none;" href="/home/house/secondhandhouse.html" target="_self" onclick=""><span class="itemName">Second-House</span></a>
                    </span>

                    <span class="item">
                        <a hidefocus="true" style="outline:none;" href="/home/house/newhouse.html" target="_self" onclick=""><span class="itemName">New-House</span></a>
                    </span>

                    <span class="item itemSelected">
                        <a hidefocus="true" style="outline:none;" href="/home/build/build.html" target="_self" onclick=""><span class="itemName">Build</span></a>
                    </span>

                    <span class="item">
                        <a hidefocus="true" style="outline:none;" href="/home/contact/contact.html" target="_self" onclick=""><span class="itemName">Contact</span></a>
                    </span>
        ...
        <section id="headerBottomTable" class="bottomTable">
            ...
            <!-- 中间 区域开启 -->
            <section id="headerBottom" class="centerTable flex-bottom-center">
...
<section id="webContainerMiddle" class="webContainerMiddle">
    ...
    <section id="webBannerTable" class="webBannerTable flex" style="min-height: 300px;">
        ...
        <section id="bannerAbsTable" class="absTopTable" style="display:block;min-height: 300px;background-size: cover;background: #F4F4F4 url('/static/uploads/new-house-max-bg.jpg') no-repeat center;">
        </section>
...
>>>>>>> b2643be6637522f05735e179f6de613271d9501e
                        ...
                        <div class="bannerNext switchBtn"></div>
                        <div class="bannerBottom"><span>1</span><span>2</span></div>
                    </div>
    ...
    <!-- This webBannerTable start -->
    <section id="webContentBody" class="webContentBody" style="display: none;">

        <div class="newsList J_newsList  newsNewModuleStyle_three "
             id="newsList385"
             _showsetting="0"
             newslisttype="5" scroll="0">
            <div topclassname="top1"
                 topswitch="on" newsid="12"
                 newsname="房产中介套路深 虚假宣传渗透交易每个环节"
                 class="J_newsListLine line noHover g_item   fk-newsLineHeight   ">
                <div class="J_newsCalendar newsCalendar newsListCalendar2"
                     style="vertical-align:top;">
                    <a class="fk-newsListDate"
                       hidefocus="true"
                       href="http://www.aliveHouse.com/nd.php?id=12&amp;_np=108_385"
                       target="_blank">2017/05/15</a>
                </div>
                <div id="lineBody12"
                     class="J_lineBody lineBody newsListLineBody2">
                    <div class="newsCircleOuter">
                        <div class="newsCircle"></div>
                    </div>
                    <div class="newsTitlePanel">
                        <div class="J_newsTitle newsTitle"
                             style="width: 100%;">
                            <div class="J_newsListTopFlag "></div>
                            <a class="fk-newsListTitle"
                               hidefocus="true"
                               href="http://www.aliveHouse.com/nd.php?id=12&amp;_np=108_385"
                               target="_blank"
                               title="房产中介套路深 虚假宣传渗透交易每个环节">房产中介套路深
                                虚假宣传渗透交易每个环节</a>
                        </div>
                        <div>
                            <p class="pic-mixNewsStyleSummary fk-newsListSummary">
                                一套叫价1.4亿元的所谓“清朝格格府邸”近日成为链家等房产中介网站上的“网红”，甚至引来北京市文物局辟谣：并非登记...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div topclassname="top1"
                 topswitch="on" newsid="13"
                 newsname="房企当下拿地 到底是&quot;馅饼&quot;还是&quot;陷阱&quot;？"
                 class="J_newsListLine line noHover g_item   fk-newsLineHeight   ">
                <div class="J_newsCalendar newsCalendar newsListCalendar2"
                     style="vertical-align:top;">
                    <a class="fk-newsListDate"
                       hidefocus="true"
                       href="http://www.aliveHouse.com/nd.php?id=13&amp;_np=108_385"
                       target="_blank">2017/05/15</a>
                </div>
                <div id="lineBody13"
                     class="J_lineBody lineBody newsListLineBody2">
                    ...
                    <div class="newsTitlePanel">
                        <div class="J_newsTitle newsTitle"
                            ...
                            <a class="fk-newsListTitle"
                               ...
                               href="http://www.aliveHouse.com/nd.php?id=13&amp;_np=108_385"
                               target="_blank"
                               title="房企当下拿地 到底是&quot;馅饼&quot;还是&quot;陷阱&quot;？">房企当下拿地
                                到底是"馅饼"还是"陷阱"？</a>
                        </div>
                        <div>
                            <p class="pic-mixNewsStyleSummary fk-newsListSummary">
                                统计显示，仅7月前10天，全国单幅地块成交金额超过5亿的地块达29宗，其中溢价率超50%的地王达18宗。一二线城市...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div topclassname="top1"
                 ...
                 newsname="北漂租房调查:月租跳涨千元 律师不愿接维权案"
                 class="J_newsListLine line noHover g_item   fk-newsLineHeight   ">
                <div class="J_newsCalendar newsCalendar newsListCalendar2"
                     style="vertical-align:top;">
                    <a class="fk-newsListDate"
                ...
                <div id="lineBody10"
                    ...
                    <div class="newsTitlePanel">
                        <div class="J_newsTitle newsTitle"
                            ...
                            <a class="fk-newsListTitle"
                               hidefocus="true"
                               href="http://www.aliveHouse.com/nd.php?id=10&amp;_np=108_385"
                               target="_blank"
                               title="北漂租房调查:月租跳涨千元 律师不愿接维权案">北漂租房调查:月租跳涨千元
                                律师不愿接维权案</a>
                        </div>
                        <div>
                            <p class="pic-mixNewsStyleSummary fk-newsListSummary">
                                “不租房不搬家，不足以谈北漂。”把最后一包行李拖进新租的房子，小段终于松了一口气。这是她来到北京三年第三次搬家，从...</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="J_separatorLine separatorLine g_separator "></div>
            <div topclassname="top1"
                 topswitch="on" newsid="14"
                 newsname="二手房过户有什么需要准备的？"
                 class="J_newsListLine line noHover g_item   fk-newsLineHeight   ">
                <div class="J_newsCalendar newsCalendar newsListCalendar2"
                     style="vertical-align:top;">
                    <a class="fk-newsListDate"
                       hidefocus="true"
                       href="http://www.aliveHouse.com/nd.php?id=14&amp;_np=108_385"
                       target="_blank">2017/05/15</a>
                </div>
                <div id="lineBody14"
                     class="J_lineBody lineBody newsListLineBody2">
                    ...
                    <div class="newsTitlePanel">
                        <div class="J_newsTitle newsTitle"
                            ...
                            <a class="fk-newsListTitle"
                               ...
                               href="http://www.aliveHouse.com/nd.php?id=14&amp;_np=108_385"
                               target="_blank"
                               title="二手房过户有什么需要准备的？">二手房过户有什么需要准备的？</a>
                        </div>
                        <div>
                            <p class="pic-mixNewsStyleSummary fk-newsListSummary">
                                购买二手房办理过户是重中之重，往往很多纠纷都会出现在过户的环节，所以我们再购买二手房之前先了解一下购房过户手续的一...</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="J_separatorLine separatorLine g_separator "></div>
            <div topclassname="top1"
                 topswitch="on" newsid="11"
                 newsname="楼市上涨效应向二线传导:厦门信贷收紧 南京土地&quot;高烧&quot;"
                 class="J_newsListLine line noHover g_item   fk-newsLineHeight   ">
                <div class="J_newsCalendar newsCalendar newsListCalendar2"
                     style="vertical-align:top;">
                    <a class="fk-newsListDate"
                       hidefocus="true"
                       href="http://www.aliveHouse.com/nd.php?id=11&amp;_np=108_385"
                       target="_blank">2017/05/15</a>
                </div>
                <div id="lineBody11"
                     class="J_lineBody lineBody newsListLineBody2">
                    ...
                    <div class="newsTitlePanel">
                        <div class="J_newsTitle newsTitle"
                            ...
                            <a class="fk-newsListTitle"
                               ...
                               href="http://www.aliveHouse.com/nd.php?id=11&amp;_np=108_385"
                               target="_blank"
                               title="楼市上涨效应向二线传导:厦门信贷收紧 南京土地&quot;高烧&quot;">楼市上涨效应向二线传导:厦门信贷收紧
                                南京土地"高烧"</a>
                        </div>
                        <div>
                            <p class="pic-mixNewsStyleSummary fk-newsListSummary">
                                近日,住建部部长座谈会召开,对于“经济走势仍然分化,新旧发展动力的转换需要一个过程,新动力的成长势头正在加快”,有...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="J_timeLine newsListTimeLine"
                 style="height: 620px; left: 105.797px;"></div>
        </div>
...
<section id="footer-content-container" class="footer-content-container flex">
    ...
    <!-- 底部 全屏操作 容器 开始 -->
    <section id="footer-full-container">
    ...
    <div class="footer-body" style="display: none;">
        ...
        <section id="footerTopTable" class="topTable" style="display: none;">
            ...
            <!-- 右侧 区域开启 -->
            <section class="rightTable flex-top-right">
        ...
        <section id="footerBottomTable" class="bottomTable">
            ...
            <!-- 中间 区域开启 -->
            <section class="centerTable flex-bottom-center">
...
<section id="extra-content-container" class="extra-content-container flex"  style="display: none;">
    ...
    <!-- 其他 全屏操作 容器 开始 -->
    <section id="extra-full-container" style="display: none;">

    </section>
    <!-- 其他 全屏操作 容器 结束 -->

    <div class="extra-body" style="display: none;">
        ...
        <section id="extraMiddleTable" class="middleTable">
            ...
            <!-- 顶级主体 中间 区域导航开启 -->
            <section class="centerTable flex-middle-center"  style="display: none;">
