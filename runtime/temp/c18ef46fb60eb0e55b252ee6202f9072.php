<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\label\update.html";i:1497965800;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<head>
    ...
    <style>
        #CreateLabel .layui-form-item{
            font-size: 16px;
        }
        #CreateLabel .layui-form-item .layui-form-label{
            width: 130px;
        }
        #CreateLabel .layui-form-item .layui-input-inline{
            width: 220px;
        }
        #CreateLabel .layui-form-item .layui-input-inline .layui-input{
            font-size: 16px;
        }
        .help-hint{
            display: block;
...
<section>
    <div style="display:flex; margin: 30px;">
        <div style="margin:auto;width: auto;height: auto;margin-top: 50px;">
            <form class="layui-form" method="post" id="CreateLabel" action="/manage/label/update.html?iframe=true&id=<?php echo $model['id']; ?>">

                <div class="layui-form-item">
                    <label class="layui-form-label">组别:</label>
                    <div class="layui-input-inline">
                         <span style="line-height: 36px;padding-left: 10px;">
                            <?php if(isset($lists[$model['type']])): ?> <?php echo $lists[$model['type']]; endif; ?>
                        </span>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="<?php echo $model['name']; ?>" name="Label[name]" placeholder="标签" class="layui-input">
                    </div>
                    <div class="layui-input-inline help-msg">
                        <i class="fa"></i>
                        <label class="help-hint"></label>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="<?php echo $model['description']; ?>" name="Label[description]" placeholder="备注" class="layui-input">
                    </div>
                    <div class="layui-input-inline help-msg">
                        <i class="fa"></i>
                        <label class="help-hint"></label>
...
<script>
    ...
    $(function(){
        var form = $("#CreateLabel").Validform({
            tiptype:alertMsg,
            showAllError:false,
            onBlur:true,
            tipSweep:true,
