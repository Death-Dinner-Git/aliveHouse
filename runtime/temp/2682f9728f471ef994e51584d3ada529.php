<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\opinion\index.html";i:1497965800;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div class="layui-field-box">
        <form class="layui-form layui-form-pane" action="">
            <div class="layui-form-item">
                ...
                <label class="layui-btn" onclick="Site.showUrl('添加一个标签','/manage/config/create.html?iframe=true','50%','62.8%','2',true,true,'LAY_LABEL_CREATE',[0.628, '#4d4d4d'])"><i class="layui-icon">&#xe608;</i>添加</label>
            </div>
        </form>
    </div>
</fieldset>
