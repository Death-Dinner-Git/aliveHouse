<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\label\index.html";i:1497965800;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <div class="layui-field-box">
        <form class="layui-form layui-form-pane" action="">
            <div class="layui-form-item">
                ...
                <label class="layui-btn" onclick="Site.showUrl('添加一个标签','/manage/label/create.html?iframe=true','50%','62.8%','2',true,true,'LAY_LABEL_CREATE',[0.628, '#4d4d4d'])">添加</label>
            </div>
        </form>
    </div>
</fieldset>
    ...
    <tr data-key="<?php echo $model['id']; ?>">
        ...
        <td style="width: 150px;text-align: center;" class="action">
            <a href="javascript:void(0);">
                <button onclick="Site.showUrl('编辑标签','/manage/label/update.html?iframe=true&id=<?php echo $model['id']; ?>','50%','62.8%','2',true,true,'LAY_LABEL_CREATE',[0.628, '#4d4d4d'],true)" class="layui-btn layui-btn-small">
                    <i class="fa fa-pencil"></i>
                    编辑
                </button>
            </a>
            <a href="javascript:void(0);"><button onclick="Site.showDialog('信息确认','你确定删除此标签吗?',function(){deleteUser(<?php echo $model['id']; ?>);},true)" class="layui-btn layui-btn-small"><i class="fa fa-remove"></i>删除</button></a>
        </td>
    </tr>
