<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\user\update.html";i:1501880917;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<section style="margin: 20px;">
    ...
    <?php endif; ?>
    <form class="layui-form forms" id="defaultForm" action="<?php echo url('manage/user/update',['id'=>$model->id]); ?>" method="post" style="padding: 15px 0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="padding-right: 120px;">
                <input type="hidden" name="department_id" value="<?php echo $model['department_id']; ?>" data-value="<?php echo $model['department_id']; ?>" lay-filter="parent" lay-search="refresh" class="layui-input" />
                <input type="text" value="<?php echo $model->getDepartment->name; ?>" data-value="<?php echo $model->getDepartment->name; ?>" lay-filter="targetParent" class="layui-input"/>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="<?php echo $model['username']; ?>" name="username" lay-verify="require" placeholder="会员名称" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text" value="<?php echo $model['phone']; ?>" name="phone" lay-verify="require" placeholder="手机号码" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" value="" name="password" placeholder="登录密码" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="password" value="" name="rePassword" placeholder="确认密码" class="layui-input">
            </div>
        </div>

        <div class="layui-form-item">
            <div class="layui-input-block">
                <input type="hidden" value="<?php echo $model['department_id']; ?>" name="old_department_id" >
                <input type="hidden" value="<?php echo $model['username']; ?>" name="old_username" >
                <input type="hidden" value="<?php echo $model['phone']; ?>" name="old_phone" >
