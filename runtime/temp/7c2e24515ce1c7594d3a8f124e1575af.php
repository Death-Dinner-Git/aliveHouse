<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\city\create.html";i:1501882272;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<section style="margin: 20px;">
    ...
    <?php endif; ?>
    <form class="layui-form forms" id="defaultForm" action="/manage/city/create" method="post" style="padding: 15px 0">

        <div class="layui-form-item">
            <label class="layui-form-label">上级城市:</label>
            <div class="layui-input-block" style="padding-right: 120px;">
                <select name="City[parent]" lay-search >
                    <option value="0">请选择</option>
                    <?php if(is_array($cityList) || $cityList instanceof \think\Collection || $cityList instanceof \think\Paginator): $i = 0; $__LIST__ = $cityList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="padding-right: 120px;">
                <input type="text" value="" name="City[name]" placeholder="城市名称" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="padding-right: 120px;">
                <input type="text" value="" name="City[data]" placeholder="城市备注" class="layui-input">
            </div>
        </div>
