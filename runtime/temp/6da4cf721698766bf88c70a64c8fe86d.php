<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\contact\index.html";i:1497965800;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        <div class="layui-field-box">
            <form class="layui-form layui-form-pane" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="<?php echo $param['key']; ?>" name="key" placeholder=" 姓名 | 手机 | 邮箱 | 地址 " class="layui-input">
                    </div>

                    <button class="layui-btn" lay-submit="">查询</button>

                    <label class="layui-btn" onclick="Site.showUrl('求购转接','/manage/contact/services.html?iframe=true','50%','62.8%','2',true,true,'LAY_LABEL_CONTACT_TRANSFER',[0.628, '#4d4d4d'],true)">求购转接</label>

                    <label class="layui-btn" onclick="Site.showUrl('求购分配','/manage/contact/assign.html?iframe=true','80%','92%','2',true,true,'LAY_LABEL_CONTACT_ASSIGN',[0.628, '#4d4d4d'],true)">求购分配</label>
                </div>
            </form>
        </div>
    </fieldset>
    ...
    <tr data-key="<?php echo $model['id']; ?>">
        ...
        <td style="width: 250px;text-align: center;" class="action">
            <a href="javascript:void(0);">
                <button onclick="Site.showUrl('查看详情','/manage/contact/view.html?id=<?php echo $model['id']; ?>','62.8%','82%','2',true,true,'LAY_TRAVEL_<?php echo $model['id']; ?>',['0.372','#000'])" class="layui-btn layui-btn-small" >
                <i class="fa fa-eye"></i>
                查看详情
                </button>
            </a>
...
<script>
    ...
    function deleteModel(id) {
        $.ajax({
            type : "post",
            url : '/manage/contact/delete?id='+ id,
            dataType : 'json',
            beforeSend : function() {
                Site.loading();
            },
