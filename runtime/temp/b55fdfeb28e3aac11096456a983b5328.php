<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\type\index.html";i:1497965800;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
        ...
        <form class="layui-form layui-form-pane" action="">
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" value="<?php echo $param['name']; ?>" name="name" placeholder="类型名称" class="layui-input">
                </div>
                ...
                <label class="layui-btn" onclick="Site.showUrl('添加一个类型','/manage/type/create.html?iframe=true','50%','62.8%','2',true,true,'LAY_LABEL_CREATE',[0.628, '#4d4d4d'])">添加</label>
...
<table class="layui-table" lay-even="" lay-skin="row">
    ...
    <tr data-key="<?php echo $model['id']; ?>">
        ...
        <td>
            <?php if(isset($lists[$model['type']])): ?>
            <?php echo $lists[$model['type']]; else: ?> 无效
            <?php endif; ?>
        </td>
        <td><?php echo $model['description']; ?></td>
        <td style="width: 150px;text-align: center;" class="action">
            <a href="javascript:void(0);">
                <button onclick="Site.showUrl('编辑类型','/manage/type/update.html?iframe=true&id=<?php echo $model['id']; ?>','50%','62.8%','2',true,true,'LAY_LABEL_CREATE',[0.628, '#4d4d4d'],true)" class="layui-btn layui-btn-small">
                    <i class="fa fa-pencil"></i>
                    编辑
                </button>
            </a>
            <a href="javascript:void(0);"><button onclick="Site.showDialog('信息确认','你确定删除此项数据吗?',function(){deleteUser(<?php echo $model['id']; ?>);},true)" class="layui-btn layui-btn-small"><i class="fa fa-remove"></i>删除</button></a>
        </td>
    </tr>
