<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\index\home.html";i:1501888718;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<div>
    <fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
        ...
        <form class="layui-form" id="default-form" action="/manage/ajax/uploader.html?file=file" method="post" enctype="multipart/form-data">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" lay-verify="layAjax" lay-url="/manage/ajax/phone" lay-error="已存在手机号" class="layui-input" />
                </div>
            </div>
            <div class="layui-form-item">
...
<script>
    layui.config({
        ...
        var uploader = layui.uploader({
            ...
            url: '/manage/ajax/uploader?file=build',
            isAjax:true,
            max:5,
