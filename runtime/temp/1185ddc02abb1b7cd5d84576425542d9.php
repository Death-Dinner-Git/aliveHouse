<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\login\login.html";i:1501870092;}*/ ?>
            ...
            <section id="content-container" style="display:flex; position:fixed;top: 0px;left: 0px;right: 0px;bottom: 0px;">
                <div id="content-body" class="signin" style="margin:-25px auto auto;width: 440px;min-height: 400px;">
                    ...
                    <div class="login-title">
                        <h2 style="text-align:center; color: #FFF; margin-bottom: 0;padding-top: 15px;"> 登陆 - 好房置业 </h2>
                    </div>

                    <form id="Login" class="layui-form" action="/manage/login/login" method="post">
                        ...
                        <div class="field submit-field">
                            <div class="layui-form-item">
                                 <span id="StandardSubmit">
                                     <input type="button" value="确定登陆" id="Submit_1" title="确定登陆" class="login-text" lay-submit="" lay-filter="submit" />
                                 </span>
                            </div>
                        </div>
