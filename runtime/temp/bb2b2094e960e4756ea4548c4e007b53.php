<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\type\create.html";i:1497965800;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <form class="layui-form" method="post" id="CreateForm" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="Type[type]" lay-search >
                            <option value="">请选择类型</option>
                            <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;if($key != 0): ?>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="" name="Type[name]" placeholder="类型名称" class="layui-input">
                    </div>
                    <div class="layui-input-inline help-msg">
                        <i class="fa"></i>
                        <label class="help-hint"></label>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="" name="Type[description]" placeholder="备注" class="layui-input">
                    </div>
                    <div class="layui-input-inline help-msg">
                        <i class="fa"></i>
                        <label class="help-hint"></label>
