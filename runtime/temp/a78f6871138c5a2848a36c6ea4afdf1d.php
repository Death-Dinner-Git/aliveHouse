...
<div class="wrap">
    ...
    <div class="layui-main dinner-header-body">
        ...
        <!-- 顶级主体左侧logo区域开启 -->
        <div class="">
            <a class="dinner-logo-title" href="javascript:void(0);" title="出车系统"><span style="">出车系统</span></a>
        </div>
        <!-- 顶级主体左侧logo区域结束 -->
