<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\guest\create.html";i:1497965800;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<section style="margin: 20px;">
    ...
    <?php endif; ?>
    <form class="layui-form" method="post" id="CreateForm" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                ...
                <input type="radio" name="Guest[level]" value="<?php echo $key; ?>" title="<?php echo $item; ?>"  <?php if($key == 1): ?>checked=""<?php endif; ?> >
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <?php if(is_array($serverLists) || $serverLists instanceof \think\Collection || $serverLists instanceof \think\Paginator): $i = 0; $__LIST__ = $serverLists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <input type="radio" name="Guest[server]" value="<?php echo $key; ?>" title="<?php echo $item; ?>"  <?php if($key == 1): ?>checked=""<?php endif; ?> >
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <?php if(is_array($typeLists) || $typeLists instanceof \think\Collection || $typeLists instanceof \think\Paginator): $i = 0; $__LIST__ = $typeLists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <input type="radio" name="Guest[type]" value="<?php echo $key; ?>" title="<?php echo $item; ?>"  <?php if($key == 1): ?>checked=""<?php endif; ?> >
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <?php if(is_array($lists) || $lists instanceof \think\Collection || $lists instanceof \think\Paginator): $i = 0; $__LIST__ = $lists;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                <input type="radio" name="Guest[city_id]" value="<?php echo $key; ?>" title="<?php echo $item; ?>"  <?php if($key == 1): ?>checked=""<?php endif; ?> >
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="" name="Guest[real_name]" placeholder="客户姓名" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="" name="Guest[ID_cards]" placeholder="身份证" class="layui-input">
            </div>
            <div class="layui-input-inline help-msg">
                <i class="fa"></i>
                <label class="help-hint"></label>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">对外称呼:</label>
            <div class="layui-input-inline">
                <input type="text" value="" name="Guest[nickname]" placeholder="对外称呼" class="layui-input">
            </div>
            <div class="layui-input-inline help-msg">
                <i class="fa"></i>
                <label class="help-hint"></label>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="" name="Guest[avatar]" placeholder="客户头像" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="" name="Guest[phone]" placeholder="手机号码" class="layui-input">
            </div>
            <div class="layui-input-inline help-msg">
                <i class="fa"></i>
                <label class="help-hint"></label>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" value="" name="Guest[address]" placeholder="详细地址" class="layui-input">
            </div>
            <div class="layui-input-inline help-msg">
                <i class="fa"></i>
                <label class="help-hint"></label>
