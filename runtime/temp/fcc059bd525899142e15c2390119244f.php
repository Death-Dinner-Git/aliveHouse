<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:92:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\department\update.html";i:1501857960;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    ...
    <form class="layui-form forms" id="defaultForm" action="" method="post" style="padding: 15px 0">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="padding-right: 120px;">
                <input type="text" value="<?php echo $model['name']; ?>" name="name" lay-verify="require" placeholder="名称" class="layui-input">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="padding-right: 120px;">
                <select name="level" lay-verify="require" lay-search="">
                    ...
                    <?php if(is_array($model->levelList) || $model->levelList instanceof \think\Collection || $model->levelList instanceof \think\Paginator): $i = 0; $__LIST__ = $model->levelList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?>
                    <option value="<?php echo $key; ?>" <?php if($model->level == $key): ?>selected<?php endif; ?>><?php echo $item; ?></option>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block" style="padding-right: 120px;">
                <input type="hidden" name="parent" value="<?php echo $model['parent']; ?>" data-value="<?php echo $model['parent']; ?>" lay-filter="parent" lay-search="refresh" class="layui-input" />
                <input type="text" value="<?php echo $model->getParent->name; ?>" data-value="<?php echo $model->getParent->name; ?>" lay-filter="targetParent" class="layui-input"/>
            </div>
        </div>
