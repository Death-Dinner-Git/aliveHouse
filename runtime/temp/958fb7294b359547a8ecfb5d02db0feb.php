<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\build\index.html";i:1501595794;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <select name="city" lay-search >
                        ...
                        <option value="<?php echo $key; ?>" <?php if($key == $param['city']): ?>selected<?php endif; ?>><?php echo $item; ?></option>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </select>
                </div>

                <div class="layui-input-inline">
                    <input type="text" value="<?php echo $param['address']; ?>" name="address" placeholder="楼盘地址" class="layui-input">
                </div>
...
<table class="layui-table layui-form" lay-even="" lay-skin="row">
    ...
    <tr data-key="<?php echo $model['id']; ?>">
        ...
        <td style="width: 100px;"><?php echo $model['title']; ?></td>
        <td>
            <?php echo $model['getCity']['name']; ?>
        </td>
        <td><?php echo $model['getBuildingDetail']['address']; ?></td>
...
<script>
    var url = {
      createUrl:"<?php echo url('/manage/build/create'); ?>",
      updateUrl:"<?php echo url('/manage/build/update'); ?>",
      viewUrl:"<?php echo url('/manage/build/view'); ?>",
      deleteUrl:"<?php echo url('/manage/build/delete'); ?>"
    };
    $(function() {
        //分页
        Site.loadPage();
