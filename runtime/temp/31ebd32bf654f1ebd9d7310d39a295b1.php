<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\city\index.html";i:1497965800;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
            ...
            <form class="layui-form layui-form-pane" action="">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" value="<?php echo $param['name']; ?>" name="name" placeholder="城市" class="layui-input">
                    </div>
                    ...
                    <label class="layui-btn" onclick="Site.showUrl('添加一个城市','/manage/city/create.html?iframe=true','50%','62.8%','2',true,true,'LAY_LABEL_CREATE',[0.628, '#4d4d4d'])">添加</label>
                </div>
            </form>
        </div>
    </fieldset>
...
<table class="layui-table" lay-even="" lay-skin="row">
    ...
    <tr data-key="<?php echo $model['id']; ?>">
        ...
        <td>
            <?php if(isset($lists[$model['level']])): ?>
            <?php echo $lists[$model['level']]; else: ?> 无效
            <?php endif; ?>
        </td>
        <td style="width: 150px;text-align: center;" class="action">
            <a href="javascript:void(0);">
                <button onclick="Site.showUrl('编辑城市','/manage/city/update.html?iframe=true&id=<?php echo $model['id']; ?>','50%','62.8%','2',true,true,'LAY_LABEL_CREATE',[0.628, '#4d4d4d'])" class="layui-btn layui-btn-small">
                    <i class="fa fa-pencil"></i>
                    编辑
                </button>
            </a>
            <a href="javascript:void(0);"><button onclick="Site.showDialog('信息确认','你确定删除此城市吗?',function(){deleteUser(<?php echo $model['id']; ?>);})" class="layui-btn layui-btn-small"><i class="fa fa-remove"></i>删除</button></a>
        </td>
    </tr>
