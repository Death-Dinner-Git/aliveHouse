<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/manage\view\house\index.html";i:1501686435;s:94:"F:\aliveDinner\upupw\www\aliveHouse\public/../application/common\view\layouts\manage-main.html";i:1501605631;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
...
<table class="layui-table layui-form" lay-even="" lay-skin="row">
    ...
    <tr data-key="<?php echo $model['id']; ?>">
        ...
        <td><?php echo $model->getTrans('statusList',$model['status']); ?></td>
...
<script>
    var url = {
        createNewHouseUrl:"<?php echo url('/manage/house/create?type=1'); ?>",
        createHandHouseUrl:"<?php echo url('/manage/house/create?type=2'); ?>",
        updateUrl:"<?php echo url('/manage/house/update'); ?>",
        viewUrl:"<?php echo url('/manage/house/view'); ?>",
        deleteUrl:"<?php echo url('/manage/house/delete'); ?>"
    };
    $(function() {
        //分页
        Site.loadPage();
