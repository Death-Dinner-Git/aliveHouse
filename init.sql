...
--
-- Host: 127.0.0.1:3306
-- Generation Time: 2017-08-08 16:24:22
...
(100, 1, '810100', 1, '10086110120', 0, NULL, 0, 'hfzy', '$2y$13$1/JAh8eDsKneF4Oq8hFwsuuRumgtzjgv9InnCgPcpNaoXI/ntDsl2', NULL, NULL, NULL, NULL, '什么都没有留下...', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '{"last":["127.0.0.1","2017-08-08 14:44:05"],"current":["127.0.0.1","2017-08-08 14:44:32"],"often":["127.0.0.1"],"haply":["127.0.0.1"],"once":{"127.0.0.1":[15,"2017-08-08 14:44:32"]}}', '127.0.0.1', NULL, NULL, '2017-08-08 14:44:32', '2017-08-08 14:44:32'),
(101, 1, '810101', 1, '10086110000', 0, NULL, 0, 'username', '$2y$13$P03uTcIfPFNu.bu2zcfgn.Y0wG7Ys/THyXus/W.FuwWiI5w9ZGtt2', 'nickname', 'realName', NULL, NULL, '什么都没有留下...', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, '0.0.0.0', NULL, NULL, '2017-08-05 02:08:44', '2017-08-05 02:08:44'),
(102, 1, '810102', 2, '10086110001', 0, NULL, 0, 'jingli', '$2y$13$4qgEk/RxhAr4EmRm8qGbGOdjk8PfKQV3Bi1pdQSJB5dnM12xXyfN6', 'nickname', 'realName', NULL, NULL, '什么都没有留下...', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, '0.0.0.0', NULL, NULL, '2017-08-05 02:08:25', '2017-08-05 02:08:25'),
(103, 1, '830103', 1, '10086110119', 0, NULL, 0, 'hf_jishu', '$2y$13$wXoWRtrfWZeLWbseIP7elObTN0gGTBQ4TS3NNHfBci8e7nx1HJsCW', NULL, NULL, NULL, NULL, '什么都没有留下...', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '{"last":["127.0.0.1","2017-08-07 12:56:59"],"current":["127.0.0.1","2017-08-07 13:05:30"],"often":[],"haply":[],"once":{"127.0.0.1":[2,"2017-08-07 13:05:30"]}}', '127.0.0.1', NULL, NULL, '2017-08-07 13:05:30', '2017-08-07 13:05:30'),
(104, 1, '830104', 3, '13656465566', 0, NULL, 0, 'hf_yewu', '$2y$13$QqJLO5FW9.Osyd9piM/PQumWFTdSCChYFiIh1P8UGrCSnltCUjVNW', NULL, NULL, NULL, NULL, '什么都没有留下...', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, '127.0.0.1', NULL, '2017-08-05 01:32:29', '2017-08-05 03:56:58', '2017-08-05 03:58:32');
...
CREATE TABLE IF NOT EXISTS `hfzy_back_user_log` (
  ...
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=168 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='后台访问记录';
...
(16, '数据统计', NULL, '/manage/data/index', 0, 1, '{"li_class":"","a_class":"Back","attr":{"target":"_blank"},"i_class":"fa fa-circle-o"}'),
...
CREATE TABLE IF NOT EXISTS `hfzy_user_login_log` (
  ...
  `created_at` datetime DEFAULT NULL COMMENT '创建时间',
  `updated_at` datetime DEFAULT NULL COMMENT '更新时间'
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='登陆记录';
...
--
ALTER TABLE `hfzy_back_user_log`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',AUTO_INCREMENT=168;
--
...
--
ALTER TABLE `hfzy_user_login_log`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '自增ID',AUTO_INCREMENT=11;
--
